            ...
            <div className="space-y-2 pt-6 pb-8 md:space-y-5">
               ...
               <div className="relative max-w-lg">
                  <input
                     ...
                     className="block w-full rounded-md border border-gray-400 bg-white px-4 py-2 text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-900 dark:bg-gray-800 dark:text-gray-100"
                  />
                  <svg
               ...
               {displayPosts.map((frontMatter) => {
                  ...
                  return (
                     ...
                     >
                        ...
                        <div className="absolute bottom-0 left-0 h-full w-0.5 origin-bottom scale-y-0 transform bg-blue-500 duration-200 group-hover:scale-y-100" />
                        <div className="absolute top-0 left-0 h-0.5 w-full origin-right scale-x-0 transform bg-blue-500 duration-200 group-hover:scale-x-100" />
                        <div className="absolute bottom-0 right-0 h-full w-0.5 origin-top scale-y-0 transform bg-blue-500 duration-200 group-hover:scale-y-100" />
